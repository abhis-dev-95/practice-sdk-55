...
export function ProfileSection() {
  ...
  const imageSize = profile.profileImageSize === "large" ? 80 : profile.profileImageSize === "medium" ? 60 : 40;

  return (
    <Section title="👤 User Profile">
      <HStack spacing={16}>
        <HStack modifiers={[frame({ width: imageSize, height: imageSize }), cornerRadius(100)]}>
          <ExpoImage
        ...
        <VStack alignment="leading">
          <Text modifiers={[font({ size: 24, weight: "bold" }), foregroundStyle(profile.theme)]}>{profile.name}</Text>
      ...
      <LabeledContent label="Mini Button">
        <Button label="Mini Button" modifiers={[buttonStyle("bordered"), controlSize("mini")]} />
      </LabeledContent>
      <LabeledContent label="Small Button">
        <Button label="Small Button" modifiers={[buttonStyle("bordered"), controlSize("small")]} />
      </LabeledContent>
      <LabeledContent label="Regular Button">
        <Button label="Regular Button" modifiers={[buttonStyle("bordered"), controlSize("regular")]} />
      </LabeledContent>
      ...
      <LabeledContent label="Glass Prominent">
        <Button
          label="Help & Support"
          modifiers={[buttonStyle("glassProminent"), controlSize("large"), tint("black"), foregroundStyle("white")]}
        />
      </LabeledContent>

      <DisclosureGroup onIsExpandedChange={setProfileExpanded} isExpanded={profileExpanded} label="Profile Settings">
        <Picker
